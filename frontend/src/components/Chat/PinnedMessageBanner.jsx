  ...
  return (
    <AnimatePresence>
      {pinnedMessage && (
        ...
        >
          <div className="mt-1 w-8 h-8 rounded-xl bg-amber-500/20 flex items-center justify-center border border-amber-500/30 shrink-0">
          ...
          {canUnpin && (
            <button 
              onClick={onUnpin}
              className="absolute right-2 top-2 p-1.5 text-zinc-500 hover:text-white bg-white/5 hover:bg-white/10 rounded-xl transition-all opacity-0 group-hover/pin:opacity-100"
              title="Unpin message"
            >
