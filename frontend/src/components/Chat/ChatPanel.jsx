...
const ChatPanel = ({ chatMuted, setChatMuted }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* ── Chat Header ── */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[#0a0a0b] shrink-0">
        ...
        >
          {chatMuted ? (
            <BellOff className="w-3.5 h-3.5" fill="currentColor" />
          ) : (
      ...
      <div className="flex-1 overflow-y-auto scroll-area px-3 pt-3 pb-3 space-y-1">
        ...
        <div className="flex items-center gap-2.5 py-1.5 px-3 mb-6 bg-white/[0.03] border border-white/5 mx-auto w-fit">
          <ShieldCheck className="w-3 h-3 text-white/40 shrink-0" fill="currentColor" />
        ...
        {showSwipeGuide && (
          <div className="mb-3  border border-fuchsia-500/30 bg-fuchsia-500/10 backdrop-blur-sm overflow-hidden animate-fade-in">
            ...
            <button
              ...
              className="w-full py-2 text-xs font-bold text-fuchsia-400 hover:bg-fuchsia-500/20 transition-colors border-t border-fuchsia-500/20"
            >
