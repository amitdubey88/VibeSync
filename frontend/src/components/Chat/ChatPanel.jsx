      ...
      <div className="flex items-center justify-between px-3 py-1.5 md:px-5 md:py-3 border-b border-white/5 bg-white/[0.03] backdrop-blur-md shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <h2 className="text-sm font-bold text-zinc-100 font-headline tracking-wide">
              Live Chat
            </h2>
        ...
        >
          ...
          >
            {chatMuted ? (
              ...
              <Bell
                className={`w-3 h-3 transition-colors ${chatMuted ? "" : "group-hover:text-fuchsia-400"}`}
              />
            )}
          </div>
            ...
            {showAttachMenu && (
              <div className="absolute bottom-full left-0 mb-2 py-2 w-48 bg-[#0a0a0b]/95 backdrop-blur-3xl border border-white/5 rounded-xl shadow-2xl z-50 animate-slide-up origin-bottom-left">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2 text-sm text-zinc-400 hover:text-white hover:bg-white/10 transition-colors text-left"
                >
                  <span className="text-[10px] font-black border-2 border-emerald-400 text-emerald-400 px-1 rounded uppercase tracking-wider flex items-center justify-center w-5 h-5 shrink-0">
                    G
                  </span>
                  Search Tenor GIF
                </button>
