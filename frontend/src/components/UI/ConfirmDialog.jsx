...
const ConfirmDialog = ({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="glass rounded-xl p-6 w-full max-w-sm shadow-modal animate-slide-up">
        <div className="flex items-start gap-4 mb-5">
          <div className={`p-2.5 rounded-lg shrink-0 ${danger ? 'bg-red-500/15' : 'bg-accent-yellow/15'}`}>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`flex-1 font-semibold rounded-lg py-2.5 text-sm transition-all active:scale-[0.98]
              ${danger
                ? 'bg-red-500 hover:bg-red-600 text-white shadow-glow-red/30'
