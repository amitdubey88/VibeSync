    ...
    <AnimatePresence>
      {isOffline && (
        <Motion.div
          ...
          exit={{ y: -50, opacity: 0 }}
          className="fixed top-0 left-0 right-0 z-[999] bg-yellow-600/90 text-white px-4 py-2 text-center text-sm font-medium backdrop-blur-md flex items-center justify-center gap-2 shadow-lg"
        >
