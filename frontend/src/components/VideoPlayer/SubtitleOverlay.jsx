    ...
    <AnimatePresence>
      {activeCue && (
        ...
        >
          ...
          <span 
            className="inline-block px-4 py-2 bg-black/70 backdrop-blur-sm  text-white font-headline font-bold md:text-2xl sm:text-lg text-base leading-tight tracking-wide"
            style={{ 
